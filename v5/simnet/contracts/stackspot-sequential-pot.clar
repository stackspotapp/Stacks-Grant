...
(define-public (start-stackspot-sequential-pot (pot-contract <stackspot-trait>))
  (begin
    ...
    (try! (as-contract? ((with-stx (var-get total-pot-value)) (with-stacking (var-get total-pot-value)))
      (try! (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.stackspots delegate-treasury pot-contract pot-treasury-address))
    ))
  ...
  (let (
    ...
    (try! 
      (as-contract? ((with-stx (var-get total-pot-value)) (with-stacking (var-get total-pot-value)))
        (try! (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.stackspots extend-delegate-treasury pot-contract 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sim-pox-4-multi-pool-v1))
      )
    )
...
(define-public (claim-pot-reward (pot-contract <stackspot-trait>))
  (let (
      ...
      (pot-yield (unwrap! (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sbtc-token get-balance pot-treasury-address) (err u997)))
      ;; Get stacked reward
    ...
    (if (not (var-get pot-session-ended))       
      (if (is-eq (+ (var-get next-payment-id) u1) total-participants)
        ...
        (begin
          ...
          (try! (as-contract? ()
            (try! 
              (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.stackspots extend-delegate-treasury pot-contract 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sim-pox-4-multi-pool-v1)
            )
          ))
...
;; Pre init
(contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.stackspots pot-deploys 
  (to-consensus-buff? 
      {
        event: "pre-init",
        pot-cycle: (var-get pot-cycle),
