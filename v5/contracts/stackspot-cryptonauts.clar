...
(define-public (cryptonauts-pay-winner (pot-contract <stackspot-trait>) (winner-address principal) (cryptonauts-treasury-address principal))
    (let
        ...
        (print {
            ...
            origin-contract-sha-hash: (contract-hash? current-contract),
            stacks-block-height: (default-to burn-block-height (var-get first-user-joined)),
