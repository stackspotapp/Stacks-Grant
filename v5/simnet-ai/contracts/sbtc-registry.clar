...
;; This repo has no sbtc-deposit. The deployer is the deposit protocol caller
;; so tests can protocol-mint sBTC into sim-pox-5 (same boot role as
;; set-burnchain-parameters / register-self). Withdrawal stays local.
