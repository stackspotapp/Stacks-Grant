...
(define-public (initiate-withdrawal-request (amount uint)
	...
	(begin
		(try! (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sbtc-token protocol-lock (+ amount max-fee) tx-sender withdraw-role))
		(asserts! (> amount DUST_LIMIT) ERR_DUST_LIMIT)

		;; Validate the recipient address
		(try! (validate-recipient recipient))

		(ok (try! (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sbtc-registry create-withdrawal-request amount max-fee tx-sender recipient burn-block-height)))
	)
)
...
(define-public (accept-withdrawal-request (request-id uint)
	...
	(let
		(
			(current-signer-data (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sbtc-registry get-current-signer-data))
			(request	(unwrap! (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sbtc-registry get-withdrawal-request request-id) ERR_INVALID_REQUEST))
			...
			(try! (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sbtc-token protocol-burn-locked (+ requested-amount requested-max-fee) requester	withdraw-role))
			...
			(if (is-eq (- requested-max-fee fee) u0)
				true
				(try! (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sbtc-token protocol-mint (- requested-max-fee fee) requester	withdraw-role))
			)

			;; Call into registry to confirm accepted withdrawal
			(try! (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sbtc-registry complete-withdrawal-accept request-id bitcoin-txid output-index signer-bitmap fee burn-hash burn-height sweep-txid))
...
(define-public (reject-withdrawal-request (request-id uint) (signer-bitmap uint))
	(let
		 (
			(current-signer-data (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sbtc-registry get-current-signer-data))
			(withdrawal (unwrap! (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sbtc-registry get-withdrawal-request request-id) ERR_INVALID_REQUEST))
		...
		(try! (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sbtc-token protocol-unlock (+ requested-amount requested-max-fee) requester	withdraw-role))

		;; Call into registry to confirm accepted withdrawal
		(try! (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sbtc-registry complete-withdrawal-reject request-id signer-bitmap))
