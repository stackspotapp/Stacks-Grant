;; title: stackspot-crowdfund
;; version: 5
;; summary: Stackspot Crowdfund Contract for Mainnet
;; description: Fixed funding recipient. Disclose's the funding recipient to participants before they join.
