...
(define-private (pull-remaining-staking-rewards)
  (let (
      ...
      (offsets (unwrap! (contract-call? 'ST23DXFQJVPA735K0HWRYFS6EF8BHJ2ENSZ3NNNMC.stackspot-vrf generate-list u0 count) ERR_NOT_FOUND))
...
(define-public (fall-back-cancel (pot-contract <stackspot-pots-trait>))
  (begin
    ...
    (let (
      ...
      (try! (contract-call? 'ST23DXFQJVPA735K0HWRYFS6EF8BHJ2ENSZ3NNNMC.stackspots log-fall-back-cancel
