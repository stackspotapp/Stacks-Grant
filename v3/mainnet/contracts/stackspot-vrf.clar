...
(define-private (add-and-shift-uint-le
    (idx uint)
    (input {
      acc: uint,
      data: (buff 16),
...
(define-read-only (lower-16-le (input (buff 32)))
  (get acc
    (fold lower-16-le-closure
      (list u16 u17 u18 u19 u20 u21 u22 u23 u24 u25 u26 u27 u28 u29 u30 u31) {
      acc: 0x,
      data: input,
    })
  )
