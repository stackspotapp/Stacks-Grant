;; --- Traits
(impl-trait 'ST3F1JGTRR0GD6VNSCM8EFE4BZ4CXG7BDPZQ3F2XJ.stackspot-trait.stackspot-trait)
(use-trait stackspot-trait 'ST3F1JGTRR0GD6VNSCM8EFE4BZ4CXG7BDPZQ3F2XJ.stackspot-trait.stackspot-trait)
...
;; Get platform fee
(define-constant platform-fee (contract-call? 'ST3F1JGTRR0GD6VNSCM8EFE4BZ4CXG7BDPZQ3F2XJ.stackspots get-fee ))
...
(define-constant platform-address (contract-call? 'ST3F1JGTRR0GD6VNSCM8EFE4BZ4CXG7BDPZQ3F2XJ.stackspots get-platform-treasury))
...
(define-read-only (get-pot-participants)
    (let (
            ...
            (n (contract-call? 'ST3F1JGTRR0GD6VNSCM8EFE4BZ4CXG7BDPZQ3F2XJ.stackspot-vrf generate-list u0 participants-count))
...
(define-read-only (get-pot-id)
    (contract-call? 'ST3F1JGTRR0GD6VNSCM8EFE4BZ4CXG7BDPZQ3F2XJ.stackspots get-token-id pot-treasury-address)
)
...
(define-private (get-random-index (participant-count uint))
    (let (
            ...
            (vrf-random-digit (unwrap! (contract-call? 'ST3F1JGTRR0GD6VNSCM8EFE4BZ4CXG7BDPZQ3F2XJ.stackspot-vrf get-random-uint-at-block stacks-block-height) ERR_NOT_FOUND))
        )
...
(define-public (cancel-pot (pot-contract <stackspot-trait>))
    (begin
      ...
      (try! (as-contract (contract-call? 'ST3F1JGTRR0GD6VNSCM8EFE4BZ4CXG7BDPZQ3F2XJ.stackspots dispatch-principals pot-contract)))
...
(define-public (start-stackspot-jackpot (pot-contract <stackspot-trait>))
    (begin
        ...
        (try! (as-contract (contract-call? 'ST3F1JGTRR0GD6VNSCM8EFE4BZ4CXG7BDPZQ3F2XJ.stackspots delegate-treasury pot-contract pot-treasury-address)))
...
(define-public (claim-pot-reward (pot-contract <stackspot-trait>))
    (let
        ...
        ;; Disburse rewards
        (try! (as-contract (contract-call? 'ST3F1JGTRR0GD6VNSCM8EFE4BZ4CXG7BDPZQ3F2XJ.stackspots dispatch-rewards pot-contract)))
...
(as-contract (contract-call? 'ST29W8BBBY984ZY1VD997WKFG1XZSXW4JWY5FM3Z4.sim-pox4-multi-pool-v1 allow-contract-caller 'ST3F1JGTRR0GD6VNSCM8EFE4BZ4CXG7BDPZQ3F2XJ.stackspot-distribute none))
